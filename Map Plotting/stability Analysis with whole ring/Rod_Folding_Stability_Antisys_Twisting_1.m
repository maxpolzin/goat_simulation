...
for mm=51
    for nn=42%:length(Q_sec_M2{mm}(1,1,:));
...
%                     E_lim=1e1;
        ...
        save('Rod_Enforced_Twisting_1.mat','E_elastic_tw','Q_sec_M3_tw','E_TW_min','Num_min','T_angle')
        ...
        save('Rod_Enforced_Twisting_1.mat','Stiff_1','Stiff_2','Stiff_3','-append')
