function [U,Delta_U,q_node,E_elastic,Delta_Energy] =...
    Element_energy2(qe,L_e,N_node,Par_E,A)
...
Delta_U=Delta_Ue+Delta_U_penalty;

E_elastic=[Ue,Ue_b,Ue_t,Ue_n,U_penalty];
Delta_Energy=[Delta_Ue,Delta_Ue_b,Delta_Ue_t,Delta_Ue_n,Delta_U_penalty];
