function Wheel_ploting(P_wheel,RM_wheel,R_wheel,N_spoke,Duplication_M)
%%
...
TM_wheel=[RM_wheel,P_wheel; 0 0 0 1];
...
Circle_Y=Spoke_Y(:,2);
Circle_Z=Spoke_Z(:,2);
Arrow_wheel=[P_wheel,P_wheel+R_wheel*RM_wheel(:,2)];
...
for ii=1:4
    ...
    plot3(Duplication_M(ii,1)*Spoke_X', ...
        ...
        plot3(Duplication_M(ii,1)*Arrow_wheel(1,:), ...
            ...
            Duplication_M(ii,3)*Arrow_wheel(3,:),'-',LineWidth=1,color=[1 0.4 0.16])
